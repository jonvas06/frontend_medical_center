...
export const routes: Routes = [
    {path: 'register-patient', component: PatientRegistrationComponent, canActivate: [AuthGuard], data: { roles: [2] } },
    {path: 'register-doctor', component: DoctorRegistrationComponent, canActivate: [AuthGuard], data: { roles: [2] }},
    {path: 'login', component: LoginComponent},
    {path: 'agendar-cita', component: AppointmentComponent, canActivate: [AuthGuard], data: { roles: [1] }},
